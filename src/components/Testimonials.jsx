    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between">
                ...
                <div>
                    <button className="btn bg-baseColor hover:bg-baseColor focus:bg-baseColor rounded-md text-white border-none outline-none text-[14px] font-[600]">View All</button>
                </div>
            </div>
        </div>
        </div>
