            ...
            <div className="flex flex-col items-center justify-center gap-10">
                <div className="flex flex-col items-center justify-center gap-5 text-center">
                    <div className="flex items-center justify-center gap-3 bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <p className='text-[16px] lg:text-[36px] font-[600]'><span className='text-baseColor'>Unlock</span> Your Creative Potential</p>
                    </div>
                    <p className='text-[16px] lg:text-[28px] font-[500]'>with Online Design and Development Courses.</p>
